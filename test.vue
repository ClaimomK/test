    ...
    <div class="licenseHeader-box">
      <el-row class="el-row">
        <el-col class="el-col" :span="24">
          <div class="grid-content bg-purple-dark">
            ...
            <el-button class="licenseSkill-box" @click="goToUpload" type="primary">
              Skill
            </el-button>
            </template>
            <template v-else>
      ...
      <div class="licenseType-box">
        <div style="margin:0 auto;">
          ...
          <button class="typeData-Specific-License-box license-flaot-box typeButton2-box"
                  @click="toTypeDataSpecificLicense()">
            Data-Specific-License
          </button>
          <button class="typeData-Source-Terms-of-Use-box license-flaot-box typeButton2-box"
